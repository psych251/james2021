...
The pilot B raw data can be found [here.](https://github.com/psych251/james2021/tree/70c74b21e44012308e57eb8eeb9dfe5976fce11f/data/pilot/PilotB_rawdata)

The pilot B clean data can be found [here.](https://github.com/psych251/james2021/tree/70c74b21e44012308e57eb8eeb9dfe5976fce11f/data/pilot/PilotB_cleandata)

The full raw data can be found [here.](https://github.com/psych251/james2021/tree/e77300292a2c0629b7eb58e65b88b2d1d95f428c/data/fulldata/raw)

The full clean data can be found [here.](https://github.com/psych251/james2021/tree/e77300292a2c0629b7eb58e65b88b2d1d95f428c/data/fulldata/clean)
...
```{r}
formGraph <- ggplot(cond.means, aes(x = session, y = mean)) +
  theme_bw() +
  geom_pirate(
    aes(colour = neighb, fill = neighb),
    show.legend = TRUE,
  ...
  scale_x_discrete(name = "Test session") +   # <-- no breaks/labels needed
  scale_y_continuous(
...
![](James21_Graph.jpeg){fig-cap="Form recognition results from James et al. (2021)" width=90%}
